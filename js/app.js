...
const quotes = [
  ...
  {text:"Act with intention, not just reaction.", author:"Original"},
  {text:"Energy flows where attention goes.", author:"James Redfield"},
  {text:"What you water grows; focus on your strengths.", author:"Original"},
  {text:"The best way to predict your future is to create it.", author:"Abraham Lincoln"},
  {text:"Courage is contagious. Be the spark.", author:"Original"},
  {text:"Dreams don’t follow schedules, but action does.", author:"Original"},
  ...
  {text:"Small steps each day lead to big transformations.", author:"Original"},
  {text:"Be the person who decides to act, not just to hope.", author:"Original"},
  {text:"Clarity comes from engagement, not thought.", author:"Marie Forleo"},
  {text:"When you shine your light, you inspire others to do the same.", author:"Original"},
  {text:"Don’t wait for opportunity. Create it.", author:"George Bernard Shaw"},
  {text:"Discomfort is the currency of growth.", author:"Original"},
  {text:"Even the tallest oak was once a seed.", author:"Original"},
  {text:"The harder the struggle, the sweeter the victory.", author:"Original"},
  {text:"Focus on the journey, not the destination.", author:"Lao Tzu"},
  {text:"Your story is still being written; make it extraordinary.", author:"Original"},
  {text:"Hustle until your haters ask if you’re hiring.", author:"Original"},
  {text:"You cannot pour from an empty cup—rest is productive.", author:"Original"},
  {text:"Life rewards action, not intention.", author:"Original"},
  {text:"Fall in love with your goals, not the applause.", author:"Original"},
  {text:"When fear whispers, courage shouts.", author:"Original"},
  {text:"The secret of success is constancy of purpose.", author:"Benjamin Disraeli"},
  {text:"Your future is created by what you do today, not tomorrow.", author:"Robert Kiyosaki"},
  {text:"Be stubborn about your goals, flexible about your methods.", author:"Original"},
  {text:"Growth begins where your excuses end.", author:"Original"},
  {text:"A new day is an invitation to rewrite your story.", author:"Original"},
  {text:"Don’t let fear write your biography.", author:"Original"},
  {text:"Excellence is a habit, not an act.", author:"Aristotle"},
  {text:"Push beyond your limits; they are often illusions.", author:"Original"},
  {text:"Start before you’re ready.", author:"Steven Pressfield"},
  {text:"The best revenge is massive success.", author:"Frank Sinatra"},
  {text:"Mastery is achieved by doing the simple things consistently.", author:"Original"},
  {text:"The biggest risk is not taking any risk.", author:"Mark Zuckerberg"},
  {text:"Turn your wounds into wisdom.", author:"Oprah Winfrey"},
  {text:"Consistency compounds.", author:"Original"},
  {text:"Your vision will become clear only when you look into your heart.", author:"Carl Jung"},
  {text:"If opportunity doesn’t knock, build a door.", author:"Milton Berle"},
  {text:"Your discipline determines your destiny.", author:"Original"},
  {text:"Courage isn’t the absence of fear, but action despite it.", author:"Mark Twain"},
  {text:"Don’t follow the path. Blaze a new trail.", author:"Original"},
  {text:"Obstacles are those frightful things you see when you take your eyes off the goal.", author:"Henry Ford"},
  {text:"Progress is better than perfection.", author:"Original"},
  {text:"Let your passion guide your purpose.", author:"Original"},
  {text:"Act, even when you feel uncertain.", author:"Original"},
  {text:"Do what you can, with what you have, where you are.", author:"Theodore Roosevelt"},
  {text:"Your only competition is the person you were yesterday.", author:"Original"},
  {text:"Dream bigger than your fears.", author:"Original"},
  {text:"If you stumble, make it part of the dance.", author:"Original"},
  {text:"Invest in yourself; it pays the best interest.", author:"Original"},
  {text:"The sky is not the limit; your mind is.", author:"Original"},
  {text:"Courage grows in moments of discomfort.", author:"Original"},
  {text:"The pain you feel today is the strength you feel tomorrow.", author:"Original"},
  {text:"Believe in progress, not perfection.", author:"Original"},
  {text:"Fear is temporary. Regret is forever.", author:"Original"},
  {text:"Opportunities multiply as they are seized.", author:"Sun Tzu"},
  {text:"Every master was once a disaster.", author:"Original"},
  {text:"You don’t need permission to succeed.", author:"Original"},
  {text:"Act with urgency, not panic.", author:"Original"},
  {text:"Greatness is earned, not given.", author:"Original"},
  {text:"The most powerful weapon against negativity is action.", author:"Original"},
  {text:"Climb mountains not so the world can see you, but so you can see the world.", author:"David McCullough Jr."},
  {text:"Push past your comfort; that’s where growth lives.", author:"Original"},
  {text:"Don’t let the noise drown out your inner voice.", author:"Steve Jobs"},
  {text:"Excuses are chains; action is freedom.", author:"Original"},
  {text:"Your attitude today determines your altitude tomorrow.", author:"Original"},
  {text:"Persist until something happens.", author:"Original"},
  {text:"When you feel like quitting, remember why you started.", author:"Original"},
  {text:"Discipline is the bridge between goals and accomplishments.", author:"Jim Rohn"},
  {text:"The journey shapes the destination.", author:"Original"},
  {text:"Let your ambition be louder than your fear.", author:"Original"},
  {text:"Stars can’t shine without darkness.", author:"D.H. Sidebottom"},
  {text:"Every expert was once a curious beginner.", author:"Original"},
  {text:"Wake up with determination. Go to bed with satisfaction.", author:"Original"},
  {text:"You are capable of more than you know.", author:"Original"},
  {text:"Hard work beats talent when talent doesn’t work hard.", author:"Tim Notke"},
  {text:"Do something today that your future self will thank you for.", author:"Original"},
  {text:"Don’t shrink to fit someone else’s expectations.", author:"Original"},
  {text:"Your legacy is built by the choices you make today.", author:"Original"},
  {text:"The most effective way to do it, is to do it.", author:"Amelia Earhart"},
  {text:"It’s the small steps that lead to big journeys.", author:"Original"},
  {text:"Great ideas come from fearless execution.", author:"Original"},
  {text:"Be the energy that inspires change.", author:"Original"},
  {text:"Success is the product of relentless preparation.", author:"Original"},
  {text:"Create something today your future self will admire.", author:"Original"},
  {text:"Vision without action is a hallucination.", author:"Thomas Edison"},
  {text:"You are the author of your own story.", author:"Original"},
  {text:"Push boundaries. Break molds. Make history.", author:"Original"},
  {text:"Consistency turns intention into reality.", author:"Original"},
  {text:"Your dreams are your blueprint; start building.", author:"Original"},
  {text:"Let persistence be your superpower.", author:"Original"},
  {text:"Every setback is a setup for a comeback.", author:"Original"},
  {text:"Success is forged in the fires of persistence.", author:"Original"},
  {text:"Your limits exist only in your mind.", author:"Original"},
  {text:"Do not wait for permission to be great.", author:"Original"},
  {text:"Momentum is more powerful than motivation.", author:"Original"},
  {text:"Take risks. Fail fast. Learn faster.", author:"Original"}
];
